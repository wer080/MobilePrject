...
public class Frag_mainlist5 extends Fragment{

    int option;

    public Frag_mainlist5(int opt){
        this.option = opt;
    }
    ...
    {
        View view = inflater.inflate(R.layout.frag_mainlist5,container,false);
        ...
        cardView = view.findViewById(R.id.main_cardView5);
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TextView main_card_id = (TextView) getView().findViewById(R.id.main_recipe_id5);
    ...
    void FilledData(InFieldData d) {
        String product_name = data_get.GetProductName().get(4);
        String product_cat = data_get.GetSpecies().get(4);
        String product_grade = data_get.GetGrade().get(4);
        String product_unit = data_get.GetUnit().get(4);
        double product_price = data_get.GetPrice().get(4);
        double product_vs = data_get.GetChangeRate().get(4);
        String string_vs = String.format("%.2f %%", product_vs);
        String product_date = data_get.GetExaminDate().get(4);


        TextView product_name_txt = (TextView) getView().findViewById(R.id.product_name5);
        product_name_txt.setText(product_name);

        TextView product_cat_txt = (TextView) getView().findViewById(R.id.product_cat5);
        product_cat_txt.setText(product_cat);

        TextView product_grade_txt = (TextView) getView().findViewById(R.id.product_grade5);
        product_grade_txt.setText(product_grade);

        TextView product_unit_txt = (TextView) getView().findViewById(R.id.product_unit5);
        product_unit_txt.setText(product_unit);

        TextView product_price_txt = (TextView) getView().findViewById(R.id.product_price5);
        product_price_txt.setText(Double.toString(product_price));

        TextView product_vs_txt = (TextView) getView().findViewById(R.id.product_vs5);
        product_vs_txt.setText(string_vs);

        TextView product_date_txt = (TextView) getView().findViewById(R.id.product_date5);
        ...
        if (recipe_code.size() > 0) {
            ...
            if (index > 0) {
                ...
                try {
                    mThread.join();
                    TextView main_card_name = (TextView) getView().findViewById(R.id.main_recipe_name5);
                    ...
                    TextView main_card_info = (TextView) getView().findViewById(R.id.main_recipe_info5);
                    main_card_info.setText(GetRecipe.getInstance().recipeInfo.get(index).GetInfo());

                    ImageView main_card_iv = (ImageView) getView().findViewById(R.id.main_recipe_img5);
