...
public class Frag_mainlist2 extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        cardView = view.findViewById(R.id.main_cardView2);
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TextView main_card_id = (TextView) getView().findViewById(R.id.main_recipe_id2);
    ...
    void FilledData(InFieldData d) {
        ...
        if (recipe_code.size() > 0) {
            ...
            if (index > 0) {
                ...
                try {
                    mThread.join();
                    TextView main_card_name = (TextView) getView().findViewById(R.id.main_recipe_name2);
                    ...
                    TextView main_card_info = (TextView) getView().findViewById(R.id.main_recipe_info2);
                    main_card_info.setText(GetRecipe.getInstance().recipeInfo.get(index).GetInfo());

                    ImageView main_card_iv = (ImageView) getView().findViewById(R.id.main_recipe_img2);
